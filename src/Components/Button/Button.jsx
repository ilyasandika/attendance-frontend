...
const Button = ({type = "submit", onClick = null, to = null, text, fill = true, danger = false, warning = false, className = ""}) => {

    let colorFill;
    const basicStyle = " font-semibold cursor-pointer px-4 py-2 rounded-md";
